...
function ProductAdmin({ productNoProp, pathArg }: ProductAdminProps) {
  ...
  return (
    <div
      ...
      className=" bg-[rgba(0,0,0,0.5)] p-2 rounded-md cursor-pointer hover:-translate-y-1 translate-y-0 transition-translation duration-500 hover:shadow-lg hover:shadow-black"
    >
